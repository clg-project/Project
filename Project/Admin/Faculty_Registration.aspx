    ...
    <asp:Panel ID="Panel1" runat="server" Height="384px" Width="499px">
        ...
        <div>            
            <table style="text-align: justify; margin-left:50px;">
                ...
                <tr>
                    <td style="width: 175px;margin-left:30px; height: 35px;"> Faculty id</td>
                    <td style="width:500px; height: 65px;">
                        <asp:TextBox ID="TextBox1" runat="server" CssClass="form-control"  Width="225px"></asp:TextBox>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server"  Display="Dynamic" ErrorMessage="*plz fill the field" ControlToValidate="TextBox1" ForeColor="Red" ValidationGroup="errmsg"></asp:RequiredFieldValidator>
                        <asp:Label ID="errfid" runat="server" ForeColor="Red"></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td style="width: 175px; height: 35px"> Faculty name</td>
